    ...
    public void run() throws IOException {
        ...
        try {
            while(true){
                ...
                String serviceName = input.readUTF();//Reads a String in modified UTF-8 format.
                String methodName = input.readUTF();
                System.out.println (serviceName);//socketrpc.IHello
                System.out.println (methodName);//sayHello
